...
//             if(typeof user[userElement] === 'object'){
//                 let div = document.createElement('div');
//                 div.innerText = `${userElement}:`;
//                 document.body.appendChild(div);
//                 for (const objInUserElement in user[userElement]) {
//                     if(typeof user[userElement][objInUserElement] === 'object'){
//                         let div = document.createElement('div');
//                         div.innerText = `${objInUserElement}:`
//                         document.body.appendChild(div)
//                         for (const geo in user[userElement][objInUserElement]) {
//                             let div = document.createElement('div');
//                             div.innerText = `${geo}: ${user[userElement][objInUserElement][geo]}`;
//                             document.body.appendChild(div);
//                         }
//                     }
//                     else{
//                         let div = document.createElement('div');
//                         div.innerText = `${objInUserElement}: ${user[userElement][objInUserElement]}`;
//                         document.body.appendChild(div);
//                     }
//                 }
//             }
...
// function pageStructure(element) {
//     // console.log(element);
...
//                 obj.headings.push(child.innerHTML);
//             }
//             if(child.tagName === 'P'){
//                 obj.paragraphs.push(child.innerHTML);
//             }
//             pageStructure(child);
//         }
//     }
...
div.onkeydown= function (e) {
    if(e.code === 'Tab'){
        div.innerText = `<${div.textContent}></${div.textContent}>`;
    }
}
